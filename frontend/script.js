...
document.addEventListener('DOMContentLoaded', () => {
    ...
    removeBtn.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(`${API_CONFIG.BASE_URL}/api/extract`, {
                method: 'POST',
    ...
    function showResult(videoUrl) {
        ...
        const proxyUrl = `${API_CONFIG.BASE_URL}/api/proxy?url=${encodeURIComponent(videoUrl)}&filename=video_no_watermark.mp4`;
